...
namespace Quilt4Net.Tests
{
    ...
    {
        internal static SessionHandler GivenThereIsASession(Mock<IWebApiClient> webApiClientMock, Mock<IConfigurationHandler> configurationMock, Action<SessionRegistrationStartedEventArgs> sessionStartedAction, Action<SessionRegistrationCompletedEventArgs> sessionCompletedAction)
        {
            ...
            var session = new SessionHandler(webApiClientMock.Object as IWebApiClient, configurationMock.Object as IConfigurationHandler, applicationHelperMock.Object as IApplicationLookup, machineHelperMock.Object as IMachineLookup, userHelperMock.Object as IUserLookup);
