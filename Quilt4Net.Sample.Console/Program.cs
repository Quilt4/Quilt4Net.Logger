...
namespace Quilt4Net.Sample.Console
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ////var client = Singleton.Quilt4Client.Instance;
            ...
            //Register issues using instanciated objects.
            var issueHandler = new IssueHandler(new SessionHandler(new Quilt4Client(new Configuration())));
            issueHandler.RegisterStart("Blah1", MessageIssueLevel.Information, null, new Dictionary<string, string> { { "A", "A1" }, { "B", "B1" } });

            //Register issues using singleton pattern.
            Singleton.Issue.Instance.RegisterStart("Blah2", MessageIssueLevel.Information, null, new Dictionary<string, string> { { "A", "A1" }, { "B", "B1" } });
