...
namespace Quilt4Net.Core
{
    ...
    {
        internal static IssueLevel ToIssueLevel(this IssueHandlerBase.ExceptionIssueLevel issueLevel, IConfiguration configuration)
        {
            IssueLevel il;
        ...
        internal static IssueLevel ToIssueLevel(this IssueHandlerBase.MessageIssueLevel issueLevel, IConfiguration configuration)
        {
            IssueLevel il;
